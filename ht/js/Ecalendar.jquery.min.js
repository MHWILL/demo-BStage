$.fn.ECalendar = function(A) {
	...
	l,
	C,
	w = A.format ? A.format: "yyyy-mm-dd hh:ii",
	...
	function J() {
		...
		b.removeAttr("name");
		a.attr("name", M);
		b.after('<span  class="cal_co" style="position: absolute;right:' + (b.height() - 20) / 2 + 'px;top:50%;margin-top: -10px;"   width="20" height="20"></span>');
		b.after(z);
